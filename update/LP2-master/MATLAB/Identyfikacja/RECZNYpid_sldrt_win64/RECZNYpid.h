...
#ifndef RTW_HEADER_RECZNYpid_h_
#define RTW_HEADER_RECZNYpid_h_
#include <string.h>
#include <stddef.h>
#include <math.h>
#ifndef RECZNYpid_COMMON_INCLUDES_
# define RECZNYpid_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* RECZNYpid_COMMON_INCLUDES_ */

#include "RECZNYpid_types.h"
...
#define RECZNYpid_rtModel              RT_MODEL_RECZNYpid_T
...
typedef struct {
  ...
  real_T Abs;                          /* '<Root>/Abs' */
  real_T ProportionalGain_m;           /* '<S1>/Proportional Gain' */
  real_T DerivativeGain_n;             /* '<S1>/Derivative Gain' */
  real_T FilterCoefficient_c;          /* '<S1>/Filter Coefficient' */
  real_T Saturation;                   /* '<Root>/Saturation' */
  real_T ManualSwitch;                 /* '<Root>/Manual Switch' */
  real_T IntegralGain;                 /* '<S1>/Integral Gain' */
  real_T SumI1;                        /* '<S1>/SumI1' */
  real_T IntegralGain_o;               /* '<S2>/Integral Gain' */
  real_T ResetEncoders;                /* '<Root>/Reset Encoders' */
  real_T SliderGain;                   /* '<S3>/Slider Gain' */
  real_T Saturation_j[2];              /* '<S5>/Saturation' */
  real_T PWM[2];                       /* '<S5>/PWM' */
...
typedef struct {
  ...
  real_T Integrator_CSTATE_i;          /* '<S1>/Integrator' */
  real_T Filter_CSTATE_c;              /* '<S1>/Filter' */
} X_RECZNYpid_T;
...
typedef struct {
  ...
  boolean_T Integrator_CSTATE_i;       /* '<S1>/Integrator' */
  boolean_T Filter_CSTATE_c;           /* '<S1>/Filter' */
} XDis_RECZNYpid_T;
...
#define rtB                            RECZNYpid_B
#define BlockIO                        B_RECZNYpid_T
#define rtX                            RECZNYpid_X
#define ContinuousStates               X_RECZNYpid_T
#define rtXdot                         RECZNYpid_XDot
#define StateDerivatives               XDot_RECZNYpid_T
#define tXdis                          RECZNYpid_XDis
#define StateDisabled                  XDis_RECZNYpid_T
#define rtP                            RECZNYpid_P
#define Parameters                     P_RECZNYpid_T
#define rtDWork                        RECZNYpid_DW
#define D_Work                         DW_RECZNYpid_T

/* Parameters (auto storage) */
struct P_RECZNYpid_T_ {
  ...
  real_T Converttorad_Gain;            /* Expression: 180
                                        ...
                                        */
  real_T Constant_Value;               /* Expression: pi/9/2*180
  ...
  real_T Switch_Threshold;             /* Expression: 10
                                        ...
                                        */
  real_T Constant1_Value;              /* Expression: 0.3611
...
extern P_RECZNYpid_T RECZNYpid_P;

/* Block signals (auto storage) */
extern B_RECZNYpid_T RECZNYpid_B;

/* Continuous states (auto storage) */
extern X_RECZNYpid_T RECZNYpid_X;

/* Block states (auto storage) */
extern DW_RECZNYpid_T RECZNYpid_DW;

/* Model entry point functions */
extern void RECZNYpid_initialize(void);
extern void RECZNYpid_output(void);
extern void RECZNYpid_update(void);
extern void RECZNYpid_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern RECZNYpid_rtModel *RECZNYpid(void);
...
extern RT_MODEL_RECZNYpid_T *const RECZNYpid_M;
 ...
 * Block '<S4>/Slider Gain' : Unused code path elimination
 ...
 *
 * '<Root>' : 'RECZNYpid'
 * '<S1>'   : 'RECZNYpid/PID Controller'
 * '<S2>'   : 'RECZNYpid/PID Controller1'
 * '<S3>'   : 'RECZNYpid/Slider Gain'
 * '<S4>'   : 'RECZNYpid/Slider Gain1'
 * '<S5>'   : 'RECZNYpid/TRAS'
 */
#endif                                 /* RTW_HEADER_RECZNYpid_h_ */
