...
MODEL                := Helikopter_new_LQI
MODULES              := Helikopter_new_LQI_data.c rtGetInf.c rtGetNaN.c rt_matrx.c rt_nonfinite.c rt_printf.c 
MAKEFILE             := Helikopter_new_LQI.mk
MATLAB_ROOT          := C:/PROGRA~1/MATLAB/R2015A~1
MATLAB_BIN           := C:/PROGRA~1/MATLAB/R2015A~1/bin
S_FUNCTIONS          := TRAS_Encoder.c TRAS_AnalogInput.c TRAS_PWM.c TRAS_ResetEncoder.c TRAS_BitstreamVersion.c TRAS_PWMTherm.c TRAS_PWMPrescaler.c TRAS_ThermFlag.c
S_FUNCTIONS_LIB      := 
SOLVER               := 
NUMST                := 2
TID01EQ              := 1
...
#
MODELLIB                  := Helikopter_new_LQIlib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := Helikopter_new_LQI_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;E:/MATLAB_WORK/LaboratoriumProblemowe/Wtorek1100/LP2-master/MATLAB/Identyfikacja/Helikopter_new_LQI_sldrt_win64;E:/MATLAB_WORK/LaboratoriumProblemowe/Wtorek1100/LP2-master/MATLAB/Identyfikacja;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
%.obj : $(MATLAB_ROOT)/toolbox/Tras/DevDriv/%.c $(MAKEFILE)
	$(call BUILDOBJ, $(CC))
...
%.obj : $(MATLAB_ROOT)/toolbox/Tras/DevDriv/%.cpp $(MAKEFILE)
	$(call BUILDOBJ, $(CPP))
