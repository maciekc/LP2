...
#ifndef RTW_HEADER_Helikopter_new_LQI_h_
#define RTW_HEADER_Helikopter_new_LQI_h_
#include <string.h>
#include <stddef.h>
#include <math.h>
#ifndef Helikopter_new_LQI_COMMON_INCLUDES_
# define Helikopter_new_LQI_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* Helikopter_new_LQI_COMMON_INCLUDES_ */

#include "Helikopter_new_LQI_types.h"
...
#define Helikopter_new_LQI_rtModel     RT_MODEL_Helikopter_new_LQI_T

/* Block signals (auto storage) */
typedef struct {
  real_T Encoder[2];                   /* '<S5>/Encoder' */
  real_T Converttorad[2];              /* '<S5>/Convert to rad' */
  real_T Gain7;                        /* '<Root>/Gain7' */
  real_T AnalogInput[2];               /* '<S5>/Analog Input' */
  real_T ConverttoRPM1[2];             /* '<S5>/Convert to RPM1' */
  real_T Gain5;                        /* '<Root>/Gain5' */
  real_T Sum3;                         /* '<Root>/Sum3' */
  real_T Sum5;                         /* '<Root>/Sum5' */
  real_T Sum4;                         /* '<Root>/Sum4' */
  real_T Gain17;                       /* '<Root>/Gain17' */
  real_T Sum33;                        /* '<Root>/Sum33' */
  real_T Integrator[3];                /* '<Root>/Integrator' */
  real_T Sum34;                        /* '<Root>/Sum34' */
  real_T Gain6;                        /* '<Root>/Gain6' */
  real_T Sum16;                        /* '<Root>/Sum16' */
  real_T Sum17;                        /* '<Root>/Sum17' */
  real_T SliderGain;                   /* '<S4>/Slider Gain' */
  real_T Add1;                         /* '<Root>/Add1' */
  real_T Sum9;                         /* '<Root>/Sum9' */
  real_T ResetEncoders;                /* '<Root>/Reset Encoders' */
  real_T SliderGain_l;                 /* '<S2>/Slider Gain' */
  real_T Sum7[3];                      /* '<Root>/Sum7' */
  real_T Saturation[2];                /* '<S5>/Saturation' */
  real_T PWM[2];                       /* '<S5>/PWM' */
  real_T ResetEncoder[2];              /* '<S5>/ResetEncoder' */
  real_T BitstreamVersion;             /* '<S5>/Bitstream Version' */
  real_T ThermStatus[2];               /* '<S5>/Therm Status' */
  real_T PWMPrescalerSource[2];        /* '<S5>/PWMPrescalerSource' */
  real_T PWMPrescaler[2];              /* '<S5>/PWMPrescaler' */
  real_T ThermFlagSource[2];           /* '<S5>/ThermFlagSource' */
  real_T ThermFlag[2];                 /* '<S5>/ThermFlag ' */
} B_Helikopter_new_LQI_T;
...
#define rtB                            Helikopter_new_LQI_B
#define BlockIO                        B_Helikopter_new_LQI_T
#define rtX                            Helikopter_new_LQI_X
#define ContinuousStates               X_Helikopter_new_LQI_T
#define rtXdot                         Helikopter_new_LQI_XDot
#define StateDerivatives               XDot_Helikopter_new_LQI_T
#define tXdis                          Helikopter_new_LQI_XDis
#define StateDisabled                  XDis_Helikopter_new_LQI_T
#define rtP                            Helikopter_new_LQI_P
#define Parameters                     P_Helikopter_new_LQI_T
#define rtDWork                        Helikopter_new_LQI_DW
#define D_Work                         DW_Helikopter_new_LQI_T

/* Parameters (auto storage) */
struct P_Helikopter_new_LQI_T_ {
  real_T K_lqi[4];                     /* Variable: K_lqi
                                        * Referenced by: '<Root>/Gain6'
                                        */
  real_T L[3];                         /* Variable: L
                                        * Referenced by: '<Root>/Gain4'
                                        */
  real_T lin_A[9];                     /* Variable: lin_A
                                        * Referenced by: '<Root>/Gain2'
                                        */
  real_T lin_B[3];                     /* Variable: lin_B
                                        * Referenced by: '<Root>/Gain1'
                                        */
  real_T lin_C[3];                     /* Variable: lin_C
                                        * Referenced by: '<Root>/Gain3'
                                        */
  real_T lin_alpha_v;                  /* Variable: lin_alpha_v
                                        * Referenced by:
                                        *   '<Root>/Constant16'
                                        *   '<Root>/Constant5'
                                        */
  real_T lin_w_v;                      /* Variable: lin_w_v
                                        * Referenced by:
                                        *   '<Root>/Constant10'
                                        *   '<Root>/Constant17'
                                        *   '<Root>/Constant6'
                                        */
  real_T wsp_V[2];                     /* Variable: wsp_V
  ...
  real_T Encoder_P2;                   /* Expression: T0
                                        * Referenced by: '<S5>/Encoder'
                                        */
  real_T Encoder1024PPR_Gain;          /* Expression: 1/1024
                                        * Referenced by: '<S5>/Encoder 1024 PPR'
                                        */
  real_T Converttorad_Gain;            /* Expression: 180
  ...
  real_T AnalogInput_P4;               /* Expression: T0
                                        * Referenced by: '<S5>/Analog Input'
                                        */
  real_T ConverttoRPM1_Gain;           /* Expression: 1000/0.52
                                        * Referenced by: '<S5>/Convert to RPM1'
                                        */
  real_T Constant4_Value;              /* Expression: pi/9
  ...
  real_T Integrator4_IC;               /* Expression: 0
                                        ...
                                        */
  real_T PitchCtrl1_Value;             /* Expression: 1
  ...
  real_T Gain16_Gain;                  /* Expression: -1
                                        ...
                                        */
  real_T AzimuthCtrl_Value;            /* Expression: 1
  ...
  real_T ThermStatus_P2;               /* Expression: T0
                                        * Referenced by: '<S5>/Therm Status'
                                        */
  real_T PWMPrescalerSource_Value[2];  /* Expression: [0 0]
...
struct tag_RTM_Helikopter_new_LQI_T {
  const char_T *path;
...
extern P_Helikopter_new_LQI_T Helikopter_new_LQI_P;

/* Block signals (auto storage) */
extern B_Helikopter_new_LQI_T Helikopter_new_LQI_B;

/* Continuous states (auto storage) */
extern X_Helikopter_new_LQI_T Helikopter_new_LQI_X;

/* Block states (auto storage) */
extern DW_Helikopter_new_LQI_T Helikopter_new_LQI_DW;

/* Model entry point functions */
extern void Helikopter_new_LQI_initialize(void);
extern void Helikopter_new_LQI_output(void);
extern void Helikopter_new_LQI_update(void);
extern void Helikopter_new_LQI_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Helikopter_new_LQI_rtModel *Helikopter_new_LQI(void);
...
extern RT_MODEL_Helikopter_new_LQI_T *const Helikopter_new_LQI_M;

/*-
 * These blocks were eliminated from the model due to optimizations:
 *
 * Block '<Root>/Pitch Ctrl' : Unused code path elimination
 * Block '<Root>/Sine Wave' : Unused code path elimination
 * Block '<S3>/Slider Gain' : Unused code path elimination
 * Block '<S5>/Azimuth Therm Status' : Unused code path elimination
 * Block '<S5>/PWMGain' : Unused code path elimination
 * Block '<S5>/PWMPrescalerGain' : Unused code path elimination
 * Block '<S5>/Pitch Therm Status' : Unused code path elimination
 * Block '<S5>/ResetEncoderGain' : Unused code path elimination
 * Block '<S5>/ThermFlagGain' : Unused code path elimination
 */
 ...
 *
 * '<Root>' : 'Helikopter_new_LQI'
 * '<S1>'   : 'Helikopter_new_LQI/MATLAB Function1'
 * '<S2>'   : 'Helikopter_new_LQI/Slider Gain'
 * '<S3>'   : 'Helikopter_new_LQI/Slider Gain1'
 * '<S4>'   : 'Helikopter_new_LQI/Slider Gain2'
 * '<S5>'   : 'Helikopter_new_LQI/TRAS'
 */
#endif                                 /* RTW_HEADER_Helikopter_new_LQI_h_ */
