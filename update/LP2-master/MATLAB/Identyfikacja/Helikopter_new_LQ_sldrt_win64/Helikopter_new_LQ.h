...
#ifndef RTW_HEADER_Helikopter_new_LQ_h_
#define RTW_HEADER_Helikopter_new_LQ_h_
#include <string.h>
#include <stddef.h>
#include <math.h>
#ifndef Helikopter_new_LQ_COMMON_INCLUDES_
# define Helikopter_new_LQ_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* Helikopter_new_LQ_COMMON_INCLUDES_ */

#include "Helikopter_new_LQ_types.h"
...
#define Helikopter_new_LQ_rtModel      RT_MODEL_Helikopter_new_LQ_T
...
#define rtB                            Helikopter_new_LQ_B
#define BlockIO                        B_Helikopter_new_LQ_T
#define rtX                            Helikopter_new_LQ_X
#define ContinuousStates               X_Helikopter_new_LQ_T
#define rtXdot                         Helikopter_new_LQ_XDot
#define StateDerivatives               XDot_Helikopter_new_LQ_T
#define tXdis                          Helikopter_new_LQ_XDis
#define StateDisabled                  XDis_Helikopter_new_LQ_T
#define rtP                            Helikopter_new_LQ_P
#define Parameters                     P_Helikopter_new_LQ_T
#define rtDWork                        Helikopter_new_LQ_DW
#define D_Work                         DW_Helikopter_new_LQ_T

/* Parameters (auto storage) */
struct P_Helikopter_new_LQ_T_ {
  real_T K_lqr[3];                     /* Variable: K_lqr
  ...
  real_T Converttorad_Gain;            /* Expression: 180
                                        ...
                                        */
  real_T Constant_Value;               /* Expression: pi/9
...
struct tag_RTM_Helikopter_new_LQ_T {
  const char_T *path;
...
extern P_Helikopter_new_LQ_T Helikopter_new_LQ_P;

/* Block signals (auto storage) */
extern B_Helikopter_new_LQ_T Helikopter_new_LQ_B;

/* Continuous states (auto storage) */
extern X_Helikopter_new_LQ_T Helikopter_new_LQ_X;

/* Block states (auto storage) */
extern DW_Helikopter_new_LQ_T Helikopter_new_LQ_DW;

/* Model entry point functions */
extern void Helikopter_new_LQ_initialize(void);
extern void Helikopter_new_LQ_output(void);
extern void Helikopter_new_LQ_update(void);
extern void Helikopter_new_LQ_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Helikopter_new_LQ_rtModel *Helikopter_new_LQ(void);
...
extern RT_MODEL_Helikopter_new_LQ_T *const Helikopter_new_LQ_M;
 ...
 *
 * '<Root>' : 'Helikopter_new_LQ'
 * '<S1>'   : 'Helikopter_new_LQ/MATLAB Function1'
 * '<S2>'   : 'Helikopter_new_LQ/Slider Gain'
 * '<S3>'   : 'Helikopter_new_LQ/Slider Gain1'
 * '<S4>'   : 'Helikopter_new_LQ/Slider Gain2'
 * '<S5>'   : 'Helikopter_new_LQ/TRAS'
 */
#endif                                 /* RTW_HEADER_Helikopter_new_LQ_h_ */
