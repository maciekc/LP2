...
MODEL                := Helikopter_new
MODULES              := Helikopter_new_data.c rtGetInf.c rtGetNaN.c rt_matrx.c rt_nonfinite.c rt_printf.c 
MAKEFILE             := Helikopter_new.mk
...
#
MODELLIB                  := Helikopter_newlib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := Helikopter_new_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;E:/MATLAB_WORK/LaboratoriumProblemowe/Wtorek1100/LP2-master/MATLAB/Identyfikacja/Helikopter_new_sldrt_win64;E:/MATLAB_WORK/LaboratoriumProblemowe/Wtorek1100/LP2-master/MATLAB/Identyfikacja;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
