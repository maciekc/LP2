...
#ifndef RTW_HEADER_Helikopter_new_h_
#define RTW_HEADER_Helikopter_new_h_
#include <string.h>
#include <stddef.h>
#include <math.h>
#ifndef Helikopter_new_COMMON_INCLUDES_
# define Helikopter_new_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* Helikopter_new_COMMON_INCLUDES_ */

#include "Helikopter_new_types.h"
...
#define Helikopter_new_rtModel         RT_MODEL_Helikopter_new_T
...
#define rtB                            Helikopter_new_B
#define BlockIO                        B_Helikopter_new_T
#define rtX                            Helikopter_new_X
#define ContinuousStates               X_Helikopter_new_T
#define rtXdot                         Helikopter_new_XDot
#define StateDerivatives               XDot_Helikopter_new_T
#define tXdis                          Helikopter_new_XDis
#define StateDisabled                  XDis_Helikopter_new_T
#define rtP                            Helikopter_new_P
#define Parameters                     P_Helikopter_new_T
#define rtDWork                        Helikopter_new_DW
#define D_Work                         DW_Helikopter_new_T

/* Parameters (auto storage) */
struct P_Helikopter_new_T_ {
...
struct tag_RTM_Helikopter_new_T {
  const char_T *path;
...
extern P_Helikopter_new_T Helikopter_new_P;

/* Block signals (auto storage) */
extern B_Helikopter_new_T Helikopter_new_B;

/* Continuous states (auto storage) */
extern X_Helikopter_new_T Helikopter_new_X;

/* Block states (auto storage) */
extern DW_Helikopter_new_T Helikopter_new_DW;

/* Model entry point functions */
extern void Helikopter_new_initialize(void);
extern void Helikopter_new_output(void);
extern void Helikopter_new_update(void);
extern void Helikopter_new_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Helikopter_new_rtModel *Helikopter_new(void);
...
extern RT_MODEL_Helikopter_new_T *const Helikopter_new_M;
 ...
 *
 * '<Root>' : 'Helikopter_new'
 * '<S1>'   : 'Helikopter_new/MATLAB Function1'
 * '<S2>'   : 'Helikopter_new/Slider Gain'
 * '<S3>'   : 'Helikopter_new/Slider Gain1'
 * '<S4>'   : 'Helikopter_new/Slider Gain2'
 * '<S5>'   : 'Helikopter_new/TRAS'
 */
#endif                                 /* RTW_HEADER_Helikopter_new_h_ */
